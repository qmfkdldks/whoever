...
#
console.log 'infinite page js loaded.'
(($, window) ->
  ...
  class InfinitePages
    ...
    defaults:
      ...
      loadingCallback: null # optional callback when next-page request begins
      successCallback: null # optional callback when next-page request finishes
      errorCallback:   null # optional callback when next-page request fails
    ...
    constructor: (container, options) ->
      ...
      @$container = $(container)
      @$table = $(container).find(@options.listSelector)
    ...
    _loading: ->
      ...
      if typeof @options.loadingCallback is 'function'
